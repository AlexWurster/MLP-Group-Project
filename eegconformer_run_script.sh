...
#     python main.py override=${model_name}_experiment debug=false trainer.wandb_args.session_name=${model_name} trainer.wandb_args.name=${model_name} model.model_args.${hp_name}=${hp_val}
# done
